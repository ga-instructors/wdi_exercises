...
# - Ruby
# - Hashes & Arrays
# How: Instructors for the quiz are written inline.
...
general_assembly[:campuses].keys.size
...
general_assembly[:campuses].values.flatten.each { |campus| puts campus[:address] }